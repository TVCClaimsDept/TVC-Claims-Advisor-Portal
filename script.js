(function (window) {
  ...
  const WaitWellChatbot = {
    config: {
      ...
      zIndex: 9999,
      botName: "Waillo",
      welcomeMessage: "Hello, I am the AI Claims Advisor. I am trained to give you accurate, up-to-date information regarding our regulatory and operational standards. I can also provide you with step-by-step guidance on how to navigate the claims process, including VA math calculations, appeals, and more. How can I assist you today?",
